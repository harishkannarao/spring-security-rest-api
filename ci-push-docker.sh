...
docker tag com.harishkannarao/spring-security-rest-api:latest $REPOSITORY_URI:$GIT_SHORT_SHA

docker tag com.harishkannarao/spring-security-rest-api:latest $REPOSITORY_URI:$ENVIRONMENT
